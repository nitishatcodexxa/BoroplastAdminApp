...
<Button variant='contained' onClick={()=>this.props.navigate('/state/add')} disableElevation startIcon={<AddIcon />} size='small' sx={{textTransform:'none',backgroundColor:'#e26511'}}>
Add State
</Button>
   </Box>
  </Grid>
...
export function Statec(props){
    const navigate = useNavigate();
    const location = useLocation();
    return (<State location={location} navigate={navigate}></State>)
  }
